...
Inom kort deadline så har jag behövt stressa fram en hel del så allting är inte så väldokumenterat som jag hade velat,
...
och använder "jackson" för att skriva POJOS till JSON och tvärtom.
